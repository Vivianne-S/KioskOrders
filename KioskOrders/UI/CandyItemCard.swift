    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                ...
                Group {
                    if item.category == "candy" { Image(systemName: "heart.fill") }
                    else if item.category == "icecream" { Image(systemName: "snowflake") }
                    else if item.category == "drinks" { Image(systemName: "cup.and.saucer.fill") }
